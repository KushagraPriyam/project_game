...
player = pygame.Rect(screen_width - 10, screen_height / 2 - 50, 10 ,100)
opponent = pygame.Rect(10, screen_height / 2 - 50, 10,100)

# Game Variables
ball_speed_x = 7.5 * random.choice((1,-1))
ball_speed_y = 7.5 * random.choice((1,-1))
player_speed = 0
opponent_speed = 7
ball_moving = False
score_time = True
